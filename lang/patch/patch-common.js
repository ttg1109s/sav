...
const LANG_PATCH_COMMON = {
    ...
    // MỚI 23/09/2026 — thanh phân trang dùng chung (core/pagination.js) + tên 4 kiểu ở Settings > System > Pagination
    ...
    'pagination.loadMoreCount': '{shown} / {total}',
    'pagination.style.arrow': 'Arrows',
    'pagination.style.list': 'Page numbers',
    'pagination.style.full': 'Arrows + numbers',
    'pagination.style.loadMore': 'Load more',
    ...
    'common.appRecovery.restoreDefaultsBody': 'Restore default settings? EVERY setting returns to factory: theme, visualizer, EQ, Motion, Filter, player, pagination, folder options (exclude, read-only, filter) — and all presets you created are deleted. Your uploaded media, folders with their contents, and listening stats are NOT deleted.',

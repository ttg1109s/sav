...
const LANG_PATCH_VISUALIZER = {
    ...
    // Game Mode Circle v1 (MỚI 16/08/2026) — modalChoice() cho màn "Kết quả" (KHÔNG dựng overlay
    // riêng nữa, xem event/workflow/gameplay.js). [XOÁ — 02/09/2026, Game Panel app-store list]
    ...
    // settings.js) — giờ "Black Hole" là 1 STYLE của group "bar", "Rubik" là 1 STYLE của group
    // "shape" (MỚI) — cần key riêng theo đúng field/group chứa nó (khớp
    // CUSTOM_EFFECT_STYLE_LABEL_KEYS, core/custom-effect.js), TÁI DÙNG y nguyên text
    ...
    'visualizerSettingsDrawer.rainStyle.street': 'Street Light',
    'visualizerSettingsDrawer.lightingStyle.label': 'Lighting style',
    'visualizerSettingsDrawer.lightingStyle.thunder': 'Thunder',
    ...
    'visualizerSettingsDrawer.autoSwitchEnable.hint': 'Automatically switches to a different effect, no manual taps needed. While enabled, tapping the effect icon in the Visualizer Control Center won\'t open the effect picker (holding it still opens Custom Effect).',
    ...
    'visualizerSettingsDrawer.autoSwitchMode.sequential': 'List order',
    'visualizerSettingsDrawer.autoSwitchMode.random': 'Random',
    'visualizerSettingsDrawer.autoSwitchTimeMode.label': 'Switch timing',
    'visualizerSettingsDrawer.autoSwitchTimeMode.fixed': 'Fixed timing',
    'visualizerSettingsDrawer.autoSwitchTimeMode.perMedia': 'Per media',
    'visualizerSettingsDrawer.autoSwitchFixedKind.label': 'Interval',
    'visualizerSettingsDrawer.autoSwitchFixedKind.const': 'Constant',
    'visualizerSettingsDrawer.autoSwitchFixedKind.random': 'Random range',
    'visualizerSettingsDrawer.autoSwitchFixed.label': 'Switch every',
    'visualizerSettingsDrawer.autoSwitchRandomMin.label': 'From',
    'visualizerSettingsDrawer.autoSwitchRandomMax.label': 'To',
    'visualizerSettingsDrawer.autoSwitchPerMedia.hint': 'Switches the effect each time a new song, video or photo starts.',
    'visualizerSettingsDrawer.autoSwitchPicker.autoSwitchVisualSecondsFixed': 'Switch every',
    'visualizerSettingsDrawer.autoSwitchPicker.autoSwitchVisualSecondsRandomMin': 'Random from',
    'visualizerSettingsDrawer.autoSwitchPicker.autoSwitchVisualSecondsRandom': 'Random up to',
    ...
    'gestureSettings.action.speedUp': 'Speed up',
    'gestureSettings.action.speedDown': 'Speed down',
    ...
    'customEffectDrawer.field.brainSignalCount': 'Input signal count',
    'customEffectDrawer.field.brainFilterStrictness': 'Filter strictness',
    'customEffectDrawer.field.brainInputSpeed': 'Input particle speed',
    'customEffectDrawer.field.brainPumpSqueeze': 'Pump squeeze (%)',
    'customEffectDrawer.field.brainPumpSensitivity': 'Pump sensitivity',
    'customEffectDrawer.field.brainNodeFlashSensitivity': 'Node flash sensitivity',
    'customEffectDrawer.field.brainOrbitDotCount': 'Orbit dot count',
    'customEffectDrawer.field.brainOrbitBeatsPerLap': 'Beats per orbit lap',
    'customEffectDrawer.field.brainOrbitTrail': 'Orbit trail length',
    'customEffectDrawer.field.brainStringAmplitude': 'String vibration (%)',
    'customEffectDrawer.field.brainStringDecayMs': 'String decay (ms)',
    'customEffectDrawer.field.brainStringDotBeats': 'Beats per string run',

...
const LANG_PATCH_SUBTITLE_SETTINGS = {
    ...
    'motionSettingsDrawer.transition.slideUp': 'Slide up',
    'motionSettingsDrawer.transition.slideDown': 'Slide down',
    ...
    'motionSettingsDrawer.transition.wipeRight': 'Wipe — from right',
    'motionSettingsDrawer.transition.wipeUp': 'Wipe — from bottom',
    ...
    'motionSettingsDrawer.transition.wideLeft': 'Wide — from left',
    'motionSettingsDrawer.transition.wideRight': 'Wide — from right',
    'motionSettingsDrawer.transition.wideUp': 'Wide — from bottom',
    'motionSettingsDrawer.transition.wideDown': 'Wide — from top',

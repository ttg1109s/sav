...
const TPL_STATIS_PANEL = `
    <div id="statis-panel" class="hidden flex flex-col items-center justify-center" style="z-index: 128;" data-uitk="panelBg">
        <div class="absolute top-0 left-0 right-0 flex items-center justify-center px-14 py-3 sm:px-16 h-14 border-b" data-uitk="dividerBorder">
        ...
        <p class="text-sm" data-uitk="textSecondary" data-i18n="statisPanel.comingSoon">${t('statisPanel.comingSoon')}</p>
    </div>
`;

 ...
 * `#statis-panel-body` — container RỖNG (SỬA 21/09/2026: header thêm nền `panelBg` — trước đây trong suốt nên nội dung cuộn xuyên qua; body `pt-14` -> `pt-20` chừa thêm khoảng thở dưới header, heading "Overview" không còn dính sát) , nội dung THẬT SỰ (3 khối kể trên) là DATA ĐỘNG (đọc toàn
...
const TPL_STATIS_PANEL = `
    <div id="statis-panel" class="hidden flex flex-col" style="z-index: 128;" data-uitk="panelBg">
        <div class="absolute top-0 left-0 right-0 flex items-center justify-center px-14 py-3 sm:px-16 h-14 z-10 border-b" data-uitk="panelBg dividerBorder">

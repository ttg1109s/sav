...
const TPL_GAME_PANEL = `
    <div id="game-panel" class="hidden flex flex-col" style="z-index: 128;" data-uitk="panelBg glassTunable">
        <div class="absolute top-0 left-0 right-0 flex items-center justify-center px-14 py-3 sm:px-16 h-14 z-10 border-b" data-uitk="dividerBorder">
            <h2 class="text-base sm:text-lg font-semibold truncate text-center" data-uitk="textPrimary" data-i18n="gamePanel.title">${t('gamePanel.title')}</h2>
            <button id="btn-game-panel-close" class="absolute right-4 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center rounded-full hover:bg-rose-500 hover:text-white transition-colors shrink-0" data-uitk="textPrimary"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg></button>
        </div>

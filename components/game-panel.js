/**
 * components/game-panel.js — Game, MỚI (đợt tái cấu trúc bottom nav) — placeholder full-screen,
...
const TPL_GAME_PANEL = `
    <div id="game-panel" class="hidden flex flex-col items-center justify-center" style="z-index: 128;">
        ...
        <p class="text-sm text-slate-400" data-i18n="gamePanel.comingSoon">${t('gamePanel.comingSoon')}</p>
    </div>
`;

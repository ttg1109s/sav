        ...
        <div class="flex-grow relative">
            ...
            <div id="visualizer-control-center" class="absolute top-16 left-3 right-3 sm:left-6 sm:right-6 glass-control-center rounded-3xl shadow-2xl transform scale-0 opacity-0 transition-all duration-300 ease-out z-[46] pointer-events-auto p-4" style="transform-origin: top left;">
                <div class="grid grid-cols-3 sm:grid-cols-6 gap-1 sm:gap-2 w-full">
                    <!-- HOTFIX 11 (08/07/2026, Giang chốt) — nút "Cài đặt" (#btn-settings) ĐÃ BỎ HẲN
                         khỏi grid này. Sau nhiều lần vá (HOTFIX 7/8/9/10) vẫn không xử lý được ổn
                         định "mở Settings ngay từ Visualizer" trên thiết bị thật — Giang quyết định
                         bỏ hẳn lối vào này thay vì tiếp tục vá: Settings giờ CHỈ mở được từ màn
                         Playlist (#btn-settings-playlist, components/playlist-view.js) — muốn mở
                         Settings lúc đang ở Visualizer, bấm #btn-back-playlist về Playlist trước.
                         Grid đổi từ 7 xuống 6 ô (grid-cols-4→3, sm:grid-cols-7→6). Toàn bộ nhánh xử
                         lý "isVisualizerActive" trong luồng mở/đóng Settings (event/router,
                         event/workflow/player-controls.js) đã được dọn sạch theo — xem HOTFIX 11 ở
                         2 file đó. -->
                    ...
                    <!-- MỚI (04/07/2026, tính năng Documents) — mở Document Reader. -->

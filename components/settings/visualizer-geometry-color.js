...
const TPL_SETTINGS_VISUALIZER = `
        ...
        <div>
            ...
            <div class="glass-modal rounded-2xl flex flex-col overflow-hidden">
                ...
                <button id="setting-open-visual-bg-settings" class="flex justify-between items-center p-4 border-b border-white/5 hover:bg-white/5 transition-colors w-full text-left">
                    <div class="flex items-center gap-3 min-w-0">
                ...
                <!-- MỚI (10/08/2026) — panel "Cử chỉ" (components/gesture-settings-drawer.js, cụm
                     router "gestureSettings"): toggle riêng cho từng nhóm cử chỉ + chọn nút Control
                     Center gán cho vuốt rìa dưới. -->
                <button id="setting-open-gesture-settings" class="flex justify-between items-center p-4 hover:bg-white/5 transition-colors w-full text-left">
                    <div class="flex items-center gap-3 min-w-0">

        ...
        <div>
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-2xl flex flex-col overflow-hidden">
                ...
                <div class="flex justify-between items-center p-4 border-b border-slate-200 hover:bg-slate-100 transition-colors">
                    ...
                    <select id="setting-playlist-media-source" class="bg-white border border-slate-300 rounded-lg px-2 py-1.5 text-xs text-slate-900 outline-none w-32 text-right">
                ...
                <div class="flex justify-between items-center p-4 border-b border-slate-200 hover:bg-slate-100 transition-colors">
                    ...
                    <select id="setting-playlist-view-mode" class="bg-white border border-slate-300 rounded-lg px-2 py-1.5 text-xs text-slate-900 outline-none w-32 text-right">
                ...
                <button id="setting-open-playlist-sort" class="flex justify-between items-center p-4 border-b border-slate-200 hover:bg-slate-100 transition-colors w-full text-left">
                ...
                <button id="setting-open-playlist-filter" class="flex justify-between items-center p-4 hover:bg-slate-100 transition-colors w-full text-left">
                    <div class="flex items-center gap-3 min-w-0">

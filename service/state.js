 ...
 */
        ...
        const STATE_SCHEMA = {
            ...
            // FIX BUG (19/07/2026, phát hiện qua console log Giang gửi khi test Space — KHÔNG
            // liên quan gì tới Space) — key này đã có default value ở buildDefaultState() (thêm
            // 07/07/2026, "phản hồi Giang mục 1", xem core/player-controls.js) nhưng CHƯA TỪNG
            // được khai vào STATE_SCHEMA — mọi appState.set('isVisualizerActive', ...) (không
            // skipCheck, core/player-controls.js dòng ~156/~312) từ lúc đó tới giờ ĐỀU ÂM THẦM THẤT
            // BẠI (AppState.set() từ chối ghi vì key lạ, chỉ log warn, không throw) — bất kỳ logic
            // nào phụ thuộc giá trị isVisualizerActive thật sự lưu đúng đều đã bị ảnh hưởng suốt.

 ...
 * core/file-manager/file-manager-photo.js, core/modal-choice-ui.js).
 *
 ...
 * entry 200 là `MODAL_CHOICE`, nhưng code thật của `core/modal-choice-ui.js` đang chạy ĐÚNG ở z-130
 * (dưới `components/loading-shield.js`, thật sự ở z-200, theo đúng comment gốc trong chính
 * modal-choice-ui.js: "vẫn DƯỚI loading-shield vì shield là trạng thái..."). SỬA lại tên/giá trị cho
 ...
 */
        ...
        // `core/modal-choice-ui.js`/`photo-ui.js` (hàm, chỉ THỰC SỰ chạy lúc người dùng thao tác —

...
| Hàm vẽ dùng chung | `core/visualizer/draw/` (mỗi hàm 1 file: `water-drop.js`, `window-frame.js`, `flying-note.js`; `spaceship-frame.js`/`space-collision-flash.js` RỖNG — KHÔNG dùng lại cho Galaxy, xem `plan-space-galaxy.md` mục B1) |

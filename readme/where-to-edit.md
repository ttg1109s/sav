...
| Hàm vẽ dùng chung | `core/visualizer/draw/` (mỗi hàm 1 file: `water-drop.js`, `window-frame.js`, `flying-note.js`; `spaceship-frame.js`/`space-collision-flash.js` RỖNG — visual Space đã xoá 20/07/2026) |

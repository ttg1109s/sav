/**
 * core/visualizer/groups/lighting/fireworks.js — [LÀM PHẲNG, 05/09/2026, yêu cầu Giang] Style
 * 'fireworks' (pháo hoa) tách riêng khỏi `core/visualizer/types/lighting.js` cũ (trước đây gộp
 * chung với 'thunder'). Nội dung hàm GIỮ NGUYÊN 100%.
 *
 ...
 *
 * `drawLightingFlash()` (chớp màn hình khi burst lớn, dùng chung với style 'thunder') nằm ở

/**
 * core/visualizer/types/space.js — vài hàm Core NHỎ, mỗi hàm 1 việc, chạy MỖI FRAME —
 * `event/workflow/visualizer-render.js` gọi RIÊNG LẺ từng hàm dưới đây theo đúng thứ tự, KHÔNG
 * hàm nào ở đây gọi hàm khác trong CHÍNH FILE NÀY, và CŨNG KHÔNG gọi bất kỳ hàm nào ở
 * `core/webgl/three-space.js` (2 file đứng NGANG HÀNG, cùng bị Workflow gọi riêng lẻ — xem quy

 ...
 *   currentTimeLabelEl, saveBtn, closeBtn, cropToggleBtn, resetBtn, flipBtn, rotateBtn }
 */
function openVideoPreviewModal(data) {
    ...
    return {
        ...
        currentTimeLabelEl, closeBtn, saveBtn, cropToggleBtn, resetBtn, flipBtn, rotateBtn,
    };
}

 ...
 */
        ...
        // MỚI (19/07/2026, "Drifting Space") — field spaceStars/spaceGalaxyStars/spaceDetail/
        // spaceMeteorPool/spaceFieldStars/spaceGalaxyCount. VIẾT LẠI LẦN 3 (19/07/2026, phản hồi
        // Giang — tách Space thành 3 kiểu con Galaxy Explore/Sun System/Vacuum Void, xem
        // core/webgl/three-space.js): spaceGalaxyStars GIẢM bớt mỗi thiên hà (Galaxy Explore giờ
        // có NHIỀU thiên hà cùng lúc trong tầm nhìn, không phải 1 thiên hà duy nhất như trước) +
        // thêm spaceGalaxyCount (số thiên hà tái sinh cùng lúc trong "đường hầm").
        const PERFORMANCE_PROFILES = {
            high: { stars: 200, tunnelRings: 60, glassDrops: 250, bldMult: 1.0, streakProb: 0.8, blurMult: 1.0, streetRain: 220, spaceStars: 2200, spaceGalaxyStars: 6000, spaceGalaxyCount: 3, spaceDetail: 28, spaceMeteorPool: 24, spaceFieldStars: 220 },
            medium: { stars: 100, tunnelRings: 35, glassDrops: 100, bldMult: 1.5, streakProb: 0.9, blurMult: 0.5, streetRain: 130, spaceStars: 1200, spaceGalaxyStars: 3000, spaceGalaxyCount: 2, spaceDetail: 18, spaceMeteorPool: 14, spaceFieldStars: 120 },
            low: { stars: 40, tunnelRings: 15, glassDrops: 40, bldMult: 2.5, streakProb: 0.95, blurMult: 0, streetRain: 70, spaceStars: 500, spaceGalaxyStars: 1500, spaceGalaxyCount: 2, spaceDetail: 10, spaceMeteorPool: 6, spaceFieldStars: 60 } 
        };
